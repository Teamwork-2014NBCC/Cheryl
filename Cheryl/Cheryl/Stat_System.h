...
{
private:
	float moveInterval = 0;			//movement speed based on spd
...
public:
	...
	float get_MoveInterval();					//adjusts movement based on spd
	float get_DodgeChance();			//adjusts dodge based on spd
	unsigned int Reduce_Incoming_Damage( unsigned int damage );		//adjusts dmg taken based on con
