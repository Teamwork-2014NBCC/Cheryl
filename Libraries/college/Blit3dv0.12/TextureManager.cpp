...
GLuint TextureManager::LoadTexture(std::string filename, bool useMipMaps, GLuint texture_unit, GLuint wrapflag)
{
...
ERROR_HANDLER:
#ifdef _WIN32			
	MessageBox(0, (LPCWSTR)"Free Image loading error!", (LPCWSTR)(filename.c_str()), MB_OK | MB_ICONEXCLAMATION);
#else
