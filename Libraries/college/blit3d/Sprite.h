...
public:
	...
	void Blit(float scale_val); //draw the sprite with set scaling
	void Blit(float x, float y, float scale_val); //draw the sprite centered at x,y with set scale
	void Sprite::Blit(float x, float y, float scale_val, float alpha_val); //draw the sprite centered at x,y with set scale and alpha
